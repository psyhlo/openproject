...
export class InAppNotificationEntryComponent implements OnInit {
  ...
  text = {
    and_other_singular: this.I18n.t('js.notifications.center.and_other_users_singular'),
    and_other_plural: (count:number):string => this.I18n.t('js.notifications.center.and_other_users_plural',
      { count }),
